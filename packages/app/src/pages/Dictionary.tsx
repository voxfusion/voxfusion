	...
	return (
		<div class="min-h-screen px-6 py-8">
			<div class="max-w-2xl mx-auto">
				...
				<div class="bg-white dark:bg-midnight-800 rounded-xl p-12 shadow-sm border border-slate-200 dark:border-midnight-700 flex flex-col items-center justify-center text-center transition-colors">
