export const privacy = {
	...
	"privacy.section2.p3":
		"2.3. Custom dictionary, app settings, and transcription history: all stored locally on your device only.",
	...
	"privacy.section4.p2": "4.2. Providing technical support to users who contact us.",
